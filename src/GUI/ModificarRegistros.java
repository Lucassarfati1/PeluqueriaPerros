...
public class ModificarRegistros extends javax.swing.JFrame {
    ...
    public ModificarRegistros(int num_cliente) {
        control=new Controlador();
        initComponents();
        cargarRegistro(num_cliente);
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(788, 530));
        setResizable(false);
        ...
        btnGuardarCambios.setIcon(new javax.swing.ImageIcon("C:\\Users\\lucas\\OneDrive\\Escritorio\\RecursosApplicaciones\\save.png")); // NOI18N
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGap(82, 82, 82)))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnGuardarCambios, javax.swing.GroupLayout.PREFERRED_SIZE, 212, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnGuardarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarCambiosActionPerformed
        ...
        control.editarRegistro(mascotaEditar, nombre,raza,color,observaciones,nombreDuenio,cel,alergico,atencion);
        
       mostrarMensaje("Se modifico correctamente", "Info", "Exito al modificar el registro");
    ...
    private void cargarRegistro(int num_cliente) {
        
        this.mascotaEditar = control.traerMascota(num_cliente);
        
        //Seteamos los valores del registro a editar
        fieldName.setText(mascotaEditar.getNombre());
        fieldCel.setText(mascotaEditar.getUnDuenio().getCelDuenio());
        fieldColor.setText(mascotaEditar.getColor());
        fieldNombreDueño.setText(mascotaEditar.getUnDuenio().getNombre());
        fieldObservaciones.setText(mascotaEditar.getObservaciones());
        fieldRaza.setText(mascotaEditar.getRaza());
        
        if(mascotaEditar.getAlergico().equals("Si")){
           
            comboAlergico.setSelectedIndex(1);
            
        }else if(mascotaEditar.getAlergico().equals("No")){
           
            comboAlergico.setSelectedIndex(2);
        }
        
        if(mascotaEditar.getAtencionEspecial().equals("Si")){
            
            comboAtencion.setSelectedIndex(1);
        
        }else if(mascotaEditar.getAtencionEspecial().equals("No")){
